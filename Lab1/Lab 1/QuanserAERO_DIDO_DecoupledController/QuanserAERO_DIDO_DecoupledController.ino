...
int yawOn=0; // flips on and off to mark status of yaw reference signal
int pitchRate=13; // period of pitch ref signal in seconds (rounded to integer to make calculations easier)
int yawRate=17; // period of yaw ref signal in seconds
float desired[4]={-0.7845,-0.5236,0,0}; // 0 => Yaw, 1 ==> Pitch
float Error[4]={0,0,0,0}; 
// ============================================================================
...
void loop() {
  ...
  if (currentMicros - previousMicros >= sampleTime) {
    ...
    //==============Setpoint Clock ===============
        ...
        SetpointGen_Team4(); // creates references for pitch and yaw angles
    //============================================
...
//    motor1Voltage = Vmotors[1]; 
 //*****************************************************end*************************************************************************************
    //*********************************Start of Custom Code for DIDO Decoupled Controller ******************************************************
    //
    float PitchRad= 0.01743*encoder2Deg;
    float YawRad=0.01743*encoder3Deg;
    //
