...
MODULES              = Lab1_PIDControllers_2018a.c
...
NCSTATES             = 0
COMPUTER             = PCWIN64
BUILDARGS            =  MAT_FILE=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 0
...
MODELREFS            = 
SHARED_SRC           = 
SHARED_SRC_DIR       = $(START_DIR)\slprj\quarc_win64\_sharedutils
SHARED_BIN_DIR       = ..\..\..\slprj\quarc_win64\_sharedutils
SHARED_LIB           = 
TARGET_LANG_EXT      = c
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Lab1_PIDControllers_2018a_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\quarc_win64\Lab1_PIDControllers_2018a
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\simulink\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\quarc_win64\_sharedutils
