...
/* Block signals for model 'Lab1_PIDControllers_2018a' */
typedef struct {
  real_T IntegralGain;                 /* '<S47>/Integral Gain' */
  real_T FilterCoefficient;            /* '<S67>/Filter Coefficient' */
  real_T FilterCoefficient_g;          /* '<S163>/Filter Coefficient' */
  real_T IntegralGain_a;               /* '<S143>/Integral Gain' */
} B_Lab1_PIDControllers_2018a_c_T;
...
typedef struct {
  B_Lab1_PIDControllers_2018a_c_T rtb;
...
extern void Lab1_PIDControllers_2018a_Reset(DW_Lab1_PIDControllers_2018_f_T
  *localDW);
extern void Lab1_PIDControllers_2018_Update(B_Lab1_PIDControllers_2018a_c_T
