  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (ACSI_Aero_Simulink_P)
    ;%
      section.nData     = 17;
      section.data(17)  = dumData; %prealloc
      
	  ;% ACSI_Aero_Simulink_P.PIDController_D
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_P.PIDController1_D
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ACSI_Aero_Simulink_P.PIDController_I
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_P.PIDController1_I
	  ...
	  ;% ACSI_Aero_Simulink_P.PIDController_P
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	
	  ;% ACSI_Aero_Simulink_P.PIDController1_P
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	
	  ;% ACSI_Aero_Simulink_P.Green_color
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	
	  ;% ACSI_Aero_Simulink_P.Yellow_color
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 15;
	
	  ;% ACSI_Aero_Simulink_P.PitchBiasRemoval_end_time
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 18;
	
	  ;% ACSI_Aero_Simulink_P.PitchBiasRemoval_start_time
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 19;
	
	  ;% ACSI_Aero_Simulink_P.PitchBiasRemoval_switch_id
	  ...
	  ;% ACSI_Aero_Simulink_P.HILReadTimebase_clock
	  ...
	  ;% ACSI_Aero_Simulink_P.HILReadTimebase_analog_channels
	  section.data(1).logicalSrcIdx = 18;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_P.HILWrite_analog_channels
	  section.data(2).logicalSrcIdx = 19;
	  section.data(2).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_P.HILReadTimebase_encoder_channel
	  section.data(3).logicalSrcIdx = 20;
	  section.data(3).dtTransOffset = 4;
	
	  ;% ACSI_Aero_Simulink_P.HILReadTimebase_other_channels
	  section.data(4).logicalSrcIdx = 21;
	  section.data(4).dtTransOffset = 6;
	
	  ;% ACSI_Aero_Simulink_P.HILWrite_other_channels
	  ...
	  ;% ACSI_Aero_Simulink_P.Saturation1_UpperSat
	  section.data(1).logicalSrcIdx = 24;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_P.Saturation1_LowerSat
	  section.data(2).logicalSrcIdx = 25;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ACSI_Aero_Simulink_P.Saturation_UpperSat
	  section.data(3).logicalSrcIdx = 26;
	  section.data(3).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_P.Saturation_LowerSat
	  section.data(4).logicalSrcIdx = 27;
	  section.data(4).dtTransOffset = 3;
	
	  ;% ACSI_Aero_Simulink_P.u4V_UpperSat
	  section.data(5).logicalSrcIdx = 28;
	  section.data(5).dtTransOffset = 4;
	
	  ;% ACSI_Aero_Simulink_P.u4V_LowerSat
	  section.data(6).logicalSrcIdx = 29;
	  section.data(6).dtTransOffset = 5;
	
	  ;% ACSI_Aero_Simulink_P.x_avg_n_Y0
	  section.data(7).logicalSrcIdx = 30;
	  section.data(7).dtTransOffset = 6;
	
	  ;% ACSI_Aero_Simulink_P.unity_Value
	  ...
	  ;% ACSI_Aero_Simulink_P.zero_Y0
	  section.data(11).logicalSrcIdx = 34;
	  section.data(11).dtTransOffset = 10;
	
	  ;% ACSI_Aero_Simulink_P.Vbiased_Y0
	  section.data(12).logicalSrcIdx = 35;
	  section.data(12).dtTransOffset = 11;
	
	  ;% ACSI_Aero_Simulink_P.Vunbiased_Y0
	  section.data(13).logicalSrcIdx = 36;
	  section.data(13).dtTransOffset = 12;
	
	  ;% ACSI_Aero_Simulink_P.Stepstart_time_Y0
	  section.data(14).logicalSrcIdx = 37;
	  section.data(14).dtTransOffset = 13;
	
	  ;% ACSI_Aero_Simulink_P.Stepstart_time_YFinal
	  section.data(15).logicalSrcIdx = 38;
	  section.data(15).dtTransOffset = 14;
	
	  ;% ACSI_Aero_Simulink_P.Stepend_time_Y0
	  ...
	  ;% ACSI_Aero_Simulink_P.HILInitialize_OOTerminate
	  section.data(18).logicalSrcIdx = 41;
	  section.data(18).dtTransOffset = 17;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_OOExit
	  section.data(19).logicalSrcIdx = 42;
	  section.data(19).dtTransOffset = 18;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_OOStart
	  section.data(20).logicalSrcIdx = 43;
	  section.data(20).dtTransOffset = 19;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_OOEnter
	  ...
	  ;% ACSI_Aero_Simulink_P.HILInitialize_CKChannels
	  ...
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AIChannels
	  ...
	  ;% ACSI_Aero_Simulink_P.HILInitialize_EIChannels
	  ...
	  ;% ACSI_Aero_Simulink_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 73;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 74;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 75;
	  section.data(3).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 76;
	  section.data(4).dtTransOffset = 3;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 77;
	  section.data(5).dtTransOffset = 4;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 78;
	  section.data(6).dtTransOffset = 5;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 79;
	  section.data(7).dtTransOffset = 6;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 80;
	  section.data(8).dtTransOffset = 7;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 81;
	  section.data(9).dtTransOffset = 8;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 82;
	  section.data(10).dtTransOffset = 9;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 83;
	  section.data(11).dtTransOffset = 10;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AIPStart
	  section.data(12).logicalSrcIdx = 84;
	  section.data(12).dtTransOffset = 11;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AIPEnter
	  section.data(13).logicalSrcIdx = 85;
	  section.data(13).dtTransOffset = 12;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOPStart
	  section.data(14).logicalSrcIdx = 86;
	  section.data(14).dtTransOffset = 13;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOPEnter
	  section.data(15).logicalSrcIdx = 87;
	  section.data(15).dtTransOffset = 14;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOStart
	  section.data(16).logicalSrcIdx = 88;
	  section.data(16).dtTransOffset = 15;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOEnter
	  section.data(17).logicalSrcIdx = 89;
	  section.data(17).dtTransOffset = 16;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 90;
	  section.data(18).dtTransOffset = 17;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 91;
	  section.data(19).dtTransOffset = 18;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 92;
	  section.data(20).dtTransOffset = 19;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOStart
	  section.data(21).logicalSrcIdx = 93;
	  section.data(21).dtTransOffset = 20;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOEnter
	  section.data(22).logicalSrcIdx = 94;
	  section.data(22).dtTransOffset = 21;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 95;
	  section.data(23).dtTransOffset = 22;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_EIPStart
	  section.data(24).logicalSrcIdx = 96;
	  section.data(24).dtTransOffset = 23;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_EIPEnter
	  section.data(25).logicalSrcIdx = 97;
	  section.data(25).dtTransOffset = 24;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_EIStart
	  section.data(26).logicalSrcIdx = 98;
	  section.data(26).dtTransOffset = 25;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_EIEnter
	  section.data(27).logicalSrcIdx = 99;
	  section.data(27).dtTransOffset = 26;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 100;
	  section.data(28).dtTransOffset = 27;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 101;
	  section.data(29).dtTransOffset = 28;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 102;
	  section.data(30).dtTransOffset = 29;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 103;
	  section.data(31).dtTransOffset = 30;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 104;
	  section.data(32).dtTransOffset = 31;
	
	  ;% ACSI_Aero_Simulink_P.HILInitialize_OOReset
	  ...
	  ;% ACSI_Aero_Simulink_P.HILReadTimebase_Active
	  section.data(36).logicalSrcIdx = 108;
	  section.data(36).dtTransOffset = 35;
	
	  ;% ACSI_Aero_Simulink_P.HILWrite_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (ACSI_Aero_Simulink_B)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% ACSI_Aero_Simulink_B.Countstorads
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_B.Sum
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_B.Pitchref
	  ...
	  ;% ACSI_Aero_Simulink_B.MotorEnable
	  section.data(7).logicalSrcIdx = 7;
	  section.data(7).dtTransOffset = 7;
	
	  ;% ACSI_Aero_Simulink_B.IntegralGain
	  section.data(8).logicalSrcIdx = 8;
	  section.data(8).dtTransOffset = 9;
	
	  ;% ACSI_Aero_Simulink_B.IntegralGain_i
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (ACSI_Aero_Simulink_DW)
    ;%
      section.nData     = 8;
	  ...
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AIMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AIMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 4;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AOMinimums
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 6;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AOMaximums
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 8;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AOVoltages
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 10;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_FilterFrequency
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% ACSI_Aero_Simulink_DW.HILWrite_PWORK
	  section.data(1).logicalSrcIdx = 10;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_DW.Scope_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 11;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ACSI_Aero_Simulink_DW.Scope1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 3;
	
	  ;% ACSI_Aero_Simulink_DW.Scope2_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 5;
	
	  ;% ACSI_Aero_Simulink_DW.Scope3_PWORK.LoggedData
	  ...
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_AIConfigValues
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_DOStates
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 3;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_QuadratureModes
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 5;
	
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_InitialEICounts
	  section.data(5).logicalSrcIdx = 19;
	  section.data(5).dtTransOffset = 9;
	
	  ;% ACSI_Aero_Simulink_DW.HILReadTimebase_EncoderBuffer
	  ...
	  ;% ACSI_Aero_Simulink_DW.SwitchCase_ActiveSubsystem
	  ...
	  ;% ACSI_Aero_Simulink_DW.HILInitialize_DOBits
  ...
  targMap.checksum0 = 4284967985;
  targMap.checksum1 = 253897905;
  targMap.checksum2 = 689750561;
  targMap.checksum3 = 3096592708;
