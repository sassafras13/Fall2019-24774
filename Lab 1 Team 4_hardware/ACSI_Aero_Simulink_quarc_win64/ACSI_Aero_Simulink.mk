...
MODEL                = ACSI_Aero_Simulink
MODULES              = ACSI_Aero_Simulink_data.c ACSI_Aero_Simulink_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = ACSI_Aero_Simulink.mk
...
MODELLIB                  = ACSI_Aero_Simulinklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ACSI_Aero_Simulink_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\ACSI_Aero_Simulink_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
