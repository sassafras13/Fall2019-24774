/*
 * Quanser_Qube_ParametricSystemID_2018.h
 *
...
#ifndef RTW_HEADER_Quanser_Qube_ParametricSystemID_2018_h_
#define RTW_HEADER_Quanser_Qube_ParametricSystemID_2018_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef Quanser_Qube_ParametricSystemID_2018_COMMON_INCLUDES_
# define Quanser_Qube_ParametricSystemID_2018_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* Quanser_Qube_ParametricSystemID_2018_COMMON_INCLUDES_ */

#include "Quanser_Qube_ParametricSystemID_2018_types.h"
...
#define Quanser_Qube_ParametricSystemID_2018_rtModel RT_MODEL_Quanser_Qube_Paramet_T
...
} B_Quanser_Qube_ParametricSyst_T;
...
} DW_Quanser_Qube_ParametricSys_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S2>/Internal' */
} X_Quanser_Qube_ParametricSyst_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S2>/Internal' */
} XDot_Quanser_Qube_ParametricS_T;

/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE[4];        /* '<S2>/Internal' */
} XDis_Quanser_Qube_ParametricS_T;
...
#define rtB                            Quanser_Qube_ParametricSystem_B
#define BlockIO                        B_Quanser_Qube_ParametricSyst_T
#define rtX                            Quanser_Qube_ParametricSystem_X
#define ContinuousStates               X_Quanser_Qube_ParametricSyst_T
#define rtXdot                         Quanser_Qube_ParametricSys_XDot
#define StateDerivatives               XDot_Quanser_Qube_ParametricS_T
#define tXdis                          Quanser_Qube_ParametricSys_XDis
#define StateDisabled                  XDis_Quanser_Qube_ParametricS_T
#define rtP                            Quanser_Qube_ParametricSystem_P
#define Parameters                     P_Quanser_Qube_ParametricSyst_T
#define rtDWork                        Quanser_Qube_ParametricSyste_DW
#define D_Work                         DW_Quanser_Qube_ParametricSys_T

/* Parameters (default storage) */
struct P_Quanser_Qube_ParametricSyst_T_ {
...
struct tag_RTM_Quanser_Qube_Parametr_T {
  const char_T *path;
...
extern P_Quanser_Qube_ParametricSyst_T Quanser_Qube_ParametricSystem_P;

/* Block signals (default storage) */
extern B_Quanser_Qube_ParametricSyst_T Quanser_Qube_ParametricSystem_B;

/* Continuous states (default storage) */
extern X_Quanser_Qube_ParametricSyst_T Quanser_Qube_ParametricSystem_X;

/* Block states (default storage) */
extern DW_Quanser_Qube_ParametricSys_T Quanser_Qube_ParametricSyste_DW;

/* Model entry point functions */
extern void Quanser_Qube_ParametricSystemID_2018_initialize(void);
extern void Quanser_Qube_ParametricSystemID_2018_output(void);
extern void Quanser_Qube_ParametricSystemID_2018_update(void);
extern void Quanser_Qube_ParametricSystemID_2018_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Quanser_Qube_ParametricSystemID_2018_rtModel
  *Quanser_Qube_ParametricSystemID_2018(void);
...
extern RT_MODEL_Quanser_Qube_Paramet_T *const Quanser_Qube_ParametricSyste_M;
 ...
 *
 * '<Root>' : 'Quanser_Qube_ParametricSystemID_2018'
 * '<S1>'   : 'Quanser_Qube_ParametricSystemID_2018/Band-Limited White Noise'
 * '<S2>'   : 'Quanser_Qube_ParametricSystemID_2018/LTI System'
 * '<S3>'   : 'Quanser_Qube_ParametricSystemID_2018/Plant'
 * '<S4>'   : 'Quanser_Qube_ParametricSystemID_2018/LTI System/Input Delay'
 * '<S5>'   : 'Quanser_Qube_ParametricSystemID_2018/LTI System/Output Delay'
 * '<S6>'   : 'Quanser_Qube_ParametricSystemID_2018/Plant/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_Quanser_Qube_ParametricSystemID_2018_h_ */
