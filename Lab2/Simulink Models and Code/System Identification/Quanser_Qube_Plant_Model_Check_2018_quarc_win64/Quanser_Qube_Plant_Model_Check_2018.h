/*
 * Quanser_Qube_Plant_Model_Check_2018.h
 *
...
#ifndef RTW_HEADER_Quanser_Qube_Plant_Model_Check_2018_h_
#define RTW_HEADER_Quanser_Qube_Plant_Model_Check_2018_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef Quanser_Qube_Plant_Model_Check_2018_COMMON_INCLUDES_
# define Quanser_Qube_Plant_Model_Check_2018_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* Quanser_Qube_Plant_Model_Check_2018_COMMON_INCLUDES_ */

#include "Quanser_Qube_Plant_Model_Check_2018_types.h"
...
#define Quanser_Qube_Plant_Model_Check_2018_rtModel RT_MODEL_Quanser_Qube_Plant_M_T
...
} DW_Quanser_Qube_Plant_Model_C_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S1>/Internal' */
} X_Quanser_Qube_Plant_Model_Ch_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S1>/Internal' */
} XDot_Quanser_Qube_Plant_Model_T;

/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE[4];        /* '<S1>/Internal' */
} XDis_Quanser_Qube_Plant_Model_T;
...
#define rtB                            Quanser_Qube_Plant_Model_Chec_B
#define BlockIO                        B_Quanser_Qube_Plant_Model_Ch_T
#define rtX                            Quanser_Qube_Plant_Model_Chec_X
#define ContinuousStates               X_Quanser_Qube_Plant_Model_Ch_T
#define rtXdot                         Quanser_Qube_Plant_Model_C_XDot
#define StateDerivatives               XDot_Quanser_Qube_Plant_Model_T
#define tXdis                          Quanser_Qube_Plant_Model_C_XDis
#define StateDisabled                  XDis_Quanser_Qube_Plant_Model_T
#define rtP                            Quanser_Qube_Plant_Model_Chec_P
#define Parameters                     P_Quanser_Qube_Plant_Model_Ch_T
#define rtDWork                        Quanser_Qube_Plant_Model_Che_DW
#define D_Work                         DW_Quanser_Qube_Plant_Model_C_T

/* Parameters (default storage) */
struct P_Quanser_Qube_Plant_Model_Ch_T_ {
  ...
  real_T SignalGenerator_Amplitude;    /* Expression: 1
                                        ...
                                        */
  real_T SignalGenerator_Frequency;    /* Expression: 6.28
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
...
struct tag_RTM_Quanser_Qube_Plant_Mo_T {
  const char_T *path;
...
extern P_Quanser_Qube_Plant_Model_Ch_T Quanser_Qube_Plant_Model_Chec_P;

/* Block signals (default storage) */
extern B_Quanser_Qube_Plant_Model_Ch_T Quanser_Qube_Plant_Model_Chec_B;

/* Continuous states (default storage) */
extern X_Quanser_Qube_Plant_Model_Ch_T Quanser_Qube_Plant_Model_Chec_X;

/* Block states (default storage) */
extern DW_Quanser_Qube_Plant_Model_C_T Quanser_Qube_Plant_Model_Che_DW;

/* Model entry point functions */
extern void Quanser_Qube_Plant_Model_Check_2018_initialize(void);
extern void Quanser_Qube_Plant_Model_Check_2018_output(void);
extern void Quanser_Qube_Plant_Model_Check_2018_update(void);
extern void Quanser_Qube_Plant_Model_Check_2018_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Quanser_Qube_Plant_Model_Check_2018_rtModel
  *Quanser_Qube_Plant_Model_Check_2018(void);
...
extern RT_MODEL_Quanser_Qube_Plant_M_T *const Quanser_Qube_Plant_Model_Che_M;
 ...
 *
 * '<Root>' : 'Quanser_Qube_Plant_Model_Check_2018'
 * '<S1>'   : 'Quanser_Qube_Plant_Model_Check_2018/LTI System'
 * '<S2>'   : 'Quanser_Qube_Plant_Model_Check_2018/Plant'
 * '<S3>'   : 'Quanser_Qube_Plant_Model_Check_2018/LTI System/Input Delay'
 * '<S4>'   : 'Quanser_Qube_Plant_Model_Check_2018/LTI System/Output Delay'
 * '<S5>'   : 'Quanser_Qube_Plant_Model_Check_2018/Plant/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_Quanser_Qube_Plant_Model_Check_2018_h_ */
