/*
 * Quanser_Qube_SystemIdentification_2018.h
 *
...
#ifndef RTW_HEADER_Quanser_Qube_SystemIdentification_2018_h_
#define RTW_HEADER_Quanser_Qube_SystemIdentification_2018_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef Quanser_Qube_SystemIdentification_2018_COMMON_INCLUDES_
# define Quanser_Qube_SystemIdentification_2018_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* Quanser_Qube_SystemIdentification_2018_COMMON_INCLUDES_ */

#include "Quanser_Qube_SystemIdentification_2018_types.h"
...
#define Quanser_Qube_SystemIdentification_2018_rtModel RT_MODEL_Quanser_Qube_SystemI_T
...
typedef struct {
  ...
  struct {
    void *LoggedData[3];
  } MotorAngletheta_PWORK;             /* '<Root>/Motor Angle (theta)' */

  struct {
    void *LoggedData[3];
  } PendulumAnglealpha_PWORK;          /* '<Root>/Pendulum Angle (alpha)' */
...
} DW_Quanser_Qube_SystemIdentif_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S2>/Internal' */
} X_Quanser_Qube_SystemIdentifi_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Internal_CSTATE[4];           /* '<S2>/Internal' */
} XDot_Quanser_Qube_SystemIdent_T;

/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE[4];        /* '<S2>/Internal' */
} XDis_Quanser_Qube_SystemIdent_T;
...
#define rtB                            Quanser_Qube_SystemIdentifica_B
#define BlockIO                        B_Quanser_Qube_SystemIdentifi_T
#define rtX                            Quanser_Qube_SystemIdentifica_X
#define ContinuousStates               X_Quanser_Qube_SystemIdentifi_T
#define rtXdot                         Quanser_Qube_SystemIdentif_XDot
#define StateDerivatives               XDot_Quanser_Qube_SystemIdent_T
#define tXdis                          Quanser_Qube_SystemIdentif_XDis
#define StateDisabled                  XDis_Quanser_Qube_SystemIdent_T
#define rtP                            Quanser_Qube_SystemIdentifica_P
#define Parameters                     P_Quanser_Qube_SystemIdentifi_T
#define rtDWork                        Quanser_Qube_SystemIdentific_DW
#define D_Work                         DW_Quanser_Qube_SystemIdentif_T

/* Parameters (default storage) */
struct P_Quanser_Qube_SystemIdentifi_T_ {
  ...
  real_T ForveCCW_Gain;                /* Expression: -1
                                        ...
                                        */
  real_T Internal_A[8];                /* Computed Parameter: Internal_A
...
struct tag_RTM_Quanser_Qube_SystemId_T {
  const char_T *path;
...
extern P_Quanser_Qube_SystemIdentifi_T Quanser_Qube_SystemIdentifica_P;

/* Block signals (default storage) */
extern B_Quanser_Qube_SystemIdentifi_T Quanser_Qube_SystemIdentifica_B;

/* Continuous states (default storage) */
extern X_Quanser_Qube_SystemIdentifi_T Quanser_Qube_SystemIdentifica_X;

/* Block states (default storage) */
extern DW_Quanser_Qube_SystemIdentif_T Quanser_Qube_SystemIdentific_DW;

/* Model entry point functions */
extern void Quanser_Qube_SystemIdentification_2018_initialize(void);
extern void Quanser_Qube_SystemIdentification_2018_output(void);
extern void Quanser_Qube_SystemIdentification_2018_update(void);
extern void Quanser_Qube_SystemIdentification_2018_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Quanser_Qube_SystemIdentification_2018_rtModel
  *Quanser_Qube_SystemIdentification_2018(void);
...
extern RT_MODEL_Quanser_Qube_SystemI_T *const Quanser_Qube_SystemIdentific_M;
 ...
 *
 * '<Root>' : 'Quanser_Qube_SystemIdentification_2018'
 * '<S1>'   : 'Quanser_Qube_SystemIdentification_2018/Chirp Signal'
 * '<S2>'   : 'Quanser_Qube_SystemIdentification_2018/LTI System'
 * '<S3>'   : 'Quanser_Qube_SystemIdentification_2018/Plant'
 * '<S4>'   : 'Quanser_Qube_SystemIdentification_2018/LTI System/Input Delay'
 * '<S5>'   : 'Quanser_Qube_SystemIdentification_2018/LTI System/Output Delay'
 * '<S6>'   : 'Quanser_Qube_SystemIdentification_2018/Plant/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_Quanser_Qube_SystemIdentification_2018_h_ */
