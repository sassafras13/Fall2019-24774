  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (Quanser_Qube_ParametricSystem_P)
    ;%
      section.nData     = 2;
      section.data(2)  = dumData; %prealloc
      
	  ;% Quanser_Qube_ParametricSystem_P.BandLimitedWhiteNoise_Cov
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSystem_P.BandLimitedWhiteNoise_seed
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILReadEncoderTimebase_clock
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILReadEncoderTimebase_channels
	  section.data(1).logicalSrcIdx = 3;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILWriteAnalog_channels
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_OOTerminate
	  section.data(1).logicalSrcIdx = 6;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_OOExit
	  section.data(2).logicalSrcIdx = 7;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_OOStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.Saturation_UpperSat
	  section.data(19).logicalSrcIdx = 24;
	  section.data(19).dtTransOffset = 24;
	
	  ;% Quanser_Qube_ParametricSystem_P.Saturation_LowerSat
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.Internal_A
	  section.data(22).logicalSrcIdx = 27;
	  section.data(22).dtTransOffset = 27;
	
	  ;% Quanser_Qube_ParametricSystem_P.Internal_B
	  section.data(23).logicalSrcIdx = 28;
	  section.data(23).dtTransOffset = 35;
	
	  ;% Quanser_Qube_ParametricSystem_P.Internal_C
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_CKChannels
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AIChannels
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_EIChannels
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 39;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AOTerminate
	  section.data(2).logicalSrcIdx = 40;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AOExit
	  section.data(3).logicalSrcIdx = 41;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOTerminate
	  section.data(4).logicalSrcIdx = 42;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOExit
	  section.data(5).logicalSrcIdx = 43;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POTerminate
	  section.data(6).logicalSrcIdx = 44;
	  section.data(6).dtTransOffset = 5;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POExit
	  section.data(7).logicalSrcIdx = 45;
	  section.data(7).dtTransOffset = 6;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_CKPStart
	  section.data(8).logicalSrcIdx = 46;
	  section.data(8).dtTransOffset = 7;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_CKPEnter
	  section.data(9).logicalSrcIdx = 47;
	  section.data(9).dtTransOffset = 8;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_CKStart
	  section.data(10).logicalSrcIdx = 48;
	  section.data(10).dtTransOffset = 9;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_CKEnter
	  section.data(11).logicalSrcIdx = 49;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AIPStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AOPStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AOStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_AOReset
	  section.data(18).logicalSrcIdx = 56;
	  section.data(18).dtTransOffset = 17;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOPStart
	  section.data(19).logicalSrcIdx = 57;
	  section.data(19).dtTransOffset = 18;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOPEnter
	  section.data(20).logicalSrcIdx = 58;
	  section.data(20).dtTransOffset = 19;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOReset
	  section.data(23).logicalSrcIdx = 61;
	  section.data(23).dtTransOffset = 22;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_EIPStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_EIStart
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POPStart
	  section.data(28).logicalSrcIdx = 66;
	  section.data(28).dtTransOffset = 27;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POPEnter
	  section.data(29).logicalSrcIdx = 67;
	  section.data(29).dtTransOffset = 28;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POStart
	  section.data(30).logicalSrcIdx = 68;
	  section.data(30).dtTransOffset = 29;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POEnter
	  section.data(31).logicalSrcIdx = 69;
	  section.data(31).dtTransOffset = 30;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_POReset
	  section.data(32).logicalSrcIdx = 70;
	  section.data(32).dtTransOffset = 31;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_OOReset
	  ...
	  ;% Quanser_Qube_ParametricSystem_P.HILInitialize_DOInitial
	  section.data(35).logicalSrcIdx = 73;
	  section.data(35).dtTransOffset = 34;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILReadEncoderTimebase_Active
	  section.data(36).logicalSrcIdx = 74;
	  section.data(36).dtTransOffset = 35;
	
	  ;% Quanser_Qube_ParametricSystem_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (Quanser_Qube_ParametricSystem_B)
    ;%
      section.nData     = 11;
	  ...
	  ;% Quanser_Qube_ParametricSystem_B.Internal
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 8;
	
	  ;% Quanser_Qube_ParametricSystem_B.TmpSignalConversionAtToFileInpo
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 12;
	
	  ;% Quanser_Qube_ParametricSystem_B.TmpSignalConversionAtToFile1Inp
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (Quanser_Qube_ParametricSyste_DW)
    ;%
      section.nData     = 2;
      section.data(2)  = dumData; %prealloc
      
	  ;% Quanser_Qube_ParametricSyste_DW.HILInitialize_FilterFrequency
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% Quanser_Qube_ParametricSyste_DW.HILWriteAnalog_PWORK
	  section.data(1).logicalSrcIdx = 4;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSyste_DW.MotorAngletheta_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 5;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Quanser_Qube_ParametricSyste_DW.PendulumAnglealpha_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 6;
	  section.data(3).dtTransOffset = 4;
	
	  ;% Quanser_Qube_ParametricSyste_DW.ToFile_PWORK.FilePtr
	  ...
	  ;% Quanser_Qube_ParametricSyste_DW.ToWorkspace1_PWORK.LoggedData
	  ...
	  ;% Quanser_Qube_ParametricSyste_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 10;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSyste_DW.HILInitialize_DOStates
	  section.data(2).logicalSrcIdx = 11;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Quanser_Qube_ParametricSyste_DW.HILInitialize_QuadratureModes
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Quanser_Qube_ParametricSyste_DW.HILInitialize_InitialEICounts
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 4;
	
	  ;% Quanser_Qube_ParametricSyste_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% Quanser_Qube_ParametricSyste_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 16;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Quanser_Qube_ParametricSyste_DW.ToFile1_IWORK.Count
  ...
  targMap.checksum0 = 1181783351;
  targMap.checksum1 = 1308684498;
  targMap.checksum2 = 1646017726;
  targMap.checksum3 = 348077071;
