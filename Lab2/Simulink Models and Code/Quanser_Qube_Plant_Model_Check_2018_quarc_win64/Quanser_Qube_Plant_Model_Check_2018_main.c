...
typedef RT_MODEL_Quanser_Qube_Plant_M_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Quanser_Qube_Plant_Model_Check_2018(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Quanser_Qube_Plant_Model_Che_M, GBLbuf.message);
}
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(Quanser_Qube_Plant_Model_Che_DW.HILReadEncoderTimebase_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Quanser_Qube_Plant_Model_Check_2018:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Quanser_Qube_Plant_Model_Check_2018 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = Quanser_Qube_Plant_Model_Check_2018();
  if (rtmGetErrorStatus(S) != NULL) {
  ...
  if (rtExtModeQuarcStartup(rtmGetRTWExtModeInfo(S),
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      result = hil_task_start
        (Quanser_Qube_Plant_Model_Che_DW.HILReadEncoderTimebase_Task, (t_clock)
         Quanser_Qube_Plant_Model_Chec_P.HILReadEncoderTimebase_clock, 500.0, -1)
        ;
      if (result == 0) {
