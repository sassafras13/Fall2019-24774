...
#ifndef RTW_HEADER_KF_LQR_hardware_h_
#define RTW_HEADER_KF_LQR_hardware_h_
#include <math.h>
#include <string.h>
#ifndef KF_LQR_hardware_COMMON_INCLUDES_
# define KF_LQR_hardware_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* KF_LQR_hardware_COMMON_INCLUDES_ */

#include "KF_LQR_hardware_types.h"
...
#define KF_LQR_hardware_rtModel        RT_MODEL_KF_LQR_hardware_T
...
typedef struct {
  ...
  real_T Reshapexhat[4];               /* '<S1>/Reshapexhat' */
  real_T Sum2[4];                      /* '<Root>/Sum2' */
  real_T Internal[2];                  /* '<S2>/Internal' */
  real_T Saturation[2];                /* '<Root>/Saturation' */
  real_T MotorEnable[2];               /* '<S5>/Motor Enable' */
  real_T Countstorads[2];              /* '<S5>/Counts to rads' */
  real_T Sum;                          /* '<S5>/Sum' */
  real_T Internal_c;                   /* '<S3>/Internal' */
  real_T Internal_f;                   /* '<S4>/Internal' */
  real_T Akxhatkk1[4];                 /* '<S23>/A[k]*xhat[k|k-1]' */
  real_T Bkuk[4];                      /* '<S23>/B[k]*u[k]' */
  real_T Add[4];                       /* '<S23>/Add' */
  real_T Stepend_time;                 /* '<S58>/Step: end_time' */
  real_T Count;                        /* '<S64>/Count' */
  real_T Sum_m;                        /* '<S60>/Sum' */
  real_T div;                          /* '<S60>/div' */
  real_T Ckxhatkk1[2];                 /* '<S48>/C[k]*xhat[k|k-1]' */
  real_T Dkuk[2];                      /* '<S48>/D[k]*u[k]' */
  real_T yhatkk1[2];                   /* '<S48>/Add1' */
  real_T Sum_d[2];                     /* '<S48>/Sum' */
  real_T Product3[4];                  /* '<S48>/Product3' */
} B_KF_LQR_hardware_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE;             /* '<S64>/Unit Delay' */
  real_T Sumk1n1xk_DSTATE;             /* '<S60>/Sum( k=1,n-1, x(k) )' */
  ...
  int8_T SwitchCase_ActiveSubsystem;   /* '<S58>/Switch Case' */
  int8_T SwitchCaseActionSubsystem2_Subs;/* '<S58>/Switch Case Action Subsystem2' */
  int8_T SwitchCaseActionSubsystem1_Subs;/* '<S58>/Switch Case Action Subsystem1' */
  int8_T SwitchCaseActionSubsystem_Subsy;/* '<S58>/Switch Case Action Subsystem' */
  int8_T EnabledMovingAverage_SubsysRanB;/* '<S58>/Enabled Moving Average' */
  int8_T MeasurementUpdate_SubsysRanBC;/* '<S23>/MeasurementUpdate' */
  boolean_T HILInitialize_DOBits[2];   /* '<S5>/HIL Initialize' */
  boolean_T EnabledMovingAverage_MODE; /* '<S58>/Enabled Moving Average' */
  boolean_T MeasurementUpdate_MODE;    /* '<S23>/MeasurementUpdate' */
} DW_KF_LQR_hardware_T;

/* Continuous states (default storage) */
typedef struct {
  real_T MemoryX_CSTATE[4];            /* '<S1>/MemoryX' */
  real_T Internal_CSTATE;              /* '<S3>/Internal' */
  real_T Internal_CSTATE_c;            /* '<S4>/Internal' */
} X_KF_LQR_hardware_T;
...
typedef struct {
  ...
  real_T Internal_CSTATE;              /* '<S3>/Internal' */
  real_T Internal_CSTATE_c;            /* '<S4>/Internal' */
} XDot_KF_LQR_hardware_T;

/* State disabled  */
typedef struct {
  boolean_T MemoryX_CSTATE[4];         /* '<S1>/MemoryX' */
  boolean_T Internal_CSTATE;           /* '<S3>/Internal' */
  boolean_T Internal_CSTATE_c;         /* '<S4>/Internal' */
} XDis_KF_LQR_hardware_T;
...
#define rtB                            KF_LQR_hardware_B
#define BlockIO                        B_KF_LQR_hardware_T
#define rtX                            KF_LQR_hardware_X
#define ContinuousStates               X_KF_LQR_hardware_T
#define rtXdot                         KF_LQR_hardware_XDot
#define StateDerivatives               XDot_KF_LQR_hardware_T
#define tXdis                          KF_LQR_hardware_XDis
#define StateDisabled                  XDis_KF_LQR_hardware_T
#define rtP                            KF_LQR_hardware_P
#define Parameters                     P_KF_LQR_hardware_T
#define rtDWork                        KF_LQR_hardware_DW
#define D_Work                         DW_KF_LQR_hardware_T

/* Parameters (default storage) */
struct P_KF_LQR_hardware_T_ {
  ...
  real_T X0_Value[4];                  /* Expression: pInitialization.X0
                                        * Referenced by: '<S1>/X0'
                                        */
  real_T Internal_D[8];                /* Computed Parameter: Internal_D
  ...
  real_T Internal_D_a;                 /* Computed Parameter: Internal_D_a
                                        * Referenced by: '<S4>/Internal'
                                        */
  real_T Internal_InitialCondition_i;  /* Expression: 0.0
                                        * Referenced by: '<S4>/Internal'
                                        */
...
struct tag_RTM_KF_LQR_hardware_T {
  const char_T *path;
...
extern P_KF_LQR_hardware_T KF_LQR_hardware_P;

/* Block signals (default storage) */
extern B_KF_LQR_hardware_T KF_LQR_hardware_B;

/* Continuous states (default storage) */
extern X_KF_LQR_hardware_T KF_LQR_hardware_X;

/* Block states (default storage) */
extern DW_KF_LQR_hardware_T KF_LQR_hardware_DW;

/* Model entry point functions */
extern void KF_LQR_hardware_initialize(void);
extern void KF_LQR_hardware_output(void);
extern void KF_LQR_hardware_update(void);
extern void KF_LQR_hardware_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern KF_LQR_hardware_rtModel *KF_LQR_hardware(void);
...
extern RT_MODEL_KF_LQR_hardware_T *const KF_LQR_hardware_M;
 ...
 *
 * '<Root>' : 'KF_LQR_hardware'
 * '<S1>'   : 'KF_LQR_hardware/Kalman Filter'
 * '<S2>'   : 'KF_LQR_hardware/LTI System1'
 * '<S3>'   : 'KF_LQR_hardware/LTI System7'
 * '<S4>'   : 'KF_LQR_hardware/LTI System8'
 * '<S5>'   : 'KF_LQR_hardware/Plant'
 * '<S6>'   : 'KF_LQR_hardware/Kalman Filter/CalculatePL'
 * '<S7>'   : 'KF_LQR_hardware/Kalman Filter/CalculateYhat'
 * '<S8>'   : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionA'
 * '<S9>'   : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionB'
 * '<S10>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionC'
 * '<S11>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionD'
 * '<S12>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionG'
 * '<S13>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionH'
 * '<S14>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionN'
 * '<S15>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionP'
 * '<S16>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionP0'
 * '<S17>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionQ'
 * '<S18>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionR'
 * '<S19>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionX'
 * '<S20>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionX0'
 * '<S21>'  : 'KF_LQR_hardware/Kalman Filter/DataTypeConversionu'
 * '<S22>'  : 'KF_LQR_hardware/Kalman Filter/MemoryP'
 * '<S23>'  : 'KF_LQR_hardware/Kalman Filter/Observer'
 * '<S24>'  : 'KF_LQR_hardware/Kalman Filter/ReducedQRN'
 * '<S25>'  : 'KF_LQR_hardware/Kalman Filter/ScalarExpansionP0'
 * '<S26>'  : 'KF_LQR_hardware/Kalman Filter/ScalarExpansionQ'
 * '<S27>'  : 'KF_LQR_hardware/Kalman Filter/ScalarExpansionR'
 * '<S28>'  : 'KF_LQR_hardware/Kalman Filter/UseCurrentEstimator'
 * '<S29>'  : 'KF_LQR_hardware/Kalman Filter/checkA'
 * '<S30>'  : 'KF_LQR_hardware/Kalman Filter/checkB'
 * '<S31>'  : 'KF_LQR_hardware/Kalman Filter/checkC'
 * '<S32>'  : 'KF_LQR_hardware/Kalman Filter/checkD'
 * '<S33>'  : 'KF_LQR_hardware/Kalman Filter/checkEnable'
 * '<S34>'  : 'KF_LQR_hardware/Kalman Filter/checkG'
 * '<S35>'  : 'KF_LQR_hardware/Kalman Filter/checkH'
 * '<S36>'  : 'KF_LQR_hardware/Kalman Filter/checkN'
 * '<S37>'  : 'KF_LQR_hardware/Kalman Filter/checkP0'
 * '<S38>'  : 'KF_LQR_hardware/Kalman Filter/checkQ'
 * '<S39>'  : 'KF_LQR_hardware/Kalman Filter/checkR'
 * '<S40>'  : 'KF_LQR_hardware/Kalman Filter/checkReset'
 * '<S41>'  : 'KF_LQR_hardware/Kalman Filter/checkX0'
 * '<S42>'  : 'KF_LQR_hardware/Kalman Filter/checku'
 * '<S43>'  : 'KF_LQR_hardware/Kalman Filter/checky'
 * '<S44>'  : 'KF_LQR_hardware/Kalman Filter/CalculatePL/DataTypeConversionL'
 * '<S45>'  : 'KF_LQR_hardware/Kalman Filter/CalculatePL/DataTypeConversionM'
 * '<S46>'  : 'KF_LQR_hardware/Kalman Filter/CalculatePL/DataTypeConversionP'
 * '<S47>'  : 'KF_LQR_hardware/Kalman Filter/CalculatePL/DataTypeConversionZ'
 * '<S48>'  : 'KF_LQR_hardware/Kalman Filter/Observer/MeasurementUpdate'
 * '<S49>'  : 'KF_LQR_hardware/LTI System1/Input Delay'
 * '<S50>'  : 'KF_LQR_hardware/LTI System1/Output Delay'
 * '<S51>'  : 'KF_LQR_hardware/LTI System7/IO Delay'
 * '<S52>'  : 'KF_LQR_hardware/LTI System7/Input Delay'
 * '<S53>'  : 'KF_LQR_hardware/LTI System7/Output Delay'
 * '<S54>'  : 'KF_LQR_hardware/LTI System8/IO Delay'
 * '<S55>'  : 'KF_LQR_hardware/LTI System8/Input Delay'
 * '<S56>'  : 'KF_LQR_hardware/LTI System8/Output Delay'
 * '<S57>'  : 'KF_LQR_hardware/Plant/Green'
 * '<S58>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal'
 * '<S59>'  : 'KF_LQR_hardware/Plant/Yellow'
 * '<S60>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal/Enabled Moving Average'
 * '<S61>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal/Switch Case Action Subsystem'
 * '<S62>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal/Switch Case Action Subsystem1'
 * '<S63>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal/Switch Case Action Subsystem2'
 * '<S64>'  : 'KF_LQR_hardware/Plant/Pitch Bias Removal/Enabled Moving Average/Increment'
 */
#endif                                 /* RTW_HEADER_KF_LQR_hardware_h_ */
