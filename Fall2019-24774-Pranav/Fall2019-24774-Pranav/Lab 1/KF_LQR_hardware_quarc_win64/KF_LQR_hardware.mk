...
MODEL                = KF_LQR_hardware
MODULES              = rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c KF_LQR_hardware_data.c KF_LQR_hardware_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = KF_LQR_hardware.mk
...
MODELLIB                  = KF_LQR_hardwarelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = KF_LQR_hardware_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\ACSI-MLC\Desktop\FALL20~1\FALL20~1\LAB1~1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\KF_LQR_hardware_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
